...
/**
 * MySQL-based implementation of the {@link WaitlistDAO} interface.
 * Uses JDBC and {@link SQLConstants} to perform CRUD operations on waitlist
 * data.
 * 
 * @author team IOTA
 */
public class WaitlistDAOImpl implements WaitlistDAO {
    ...
    /**
     * Default constructor for WaitlistDAOImpl.
     */
